...
import {
    getCountries, setSortTypeAtoZ, setSortTypeOceania, setSortTypeSmalerThanLituen, setSortTypeZtoA
...
const CountriesContainer = () => {
    ...
    const onSorted = (sortType) => {
        switch (sortType) {
            case 'A_Z':
                return (setCurrentPage(1), dispatch(setSortTypeAtoZ()), setCountriesToRender(sortedCountriesList))
            case 'Z_A':
                return (setCurrentPage(1), dispatch(setSortTypeZtoA()), setCountriesToRender(sortedCountriesList))
            case 'smallerThanLithuania':
                return (setCurrentPage(1), dispatch(setSortTypeSmalerThanLituen()), setCountriesToRender(sortedCountriesList))
            case 'Oceania':
                return (setCurrentPage(1), dispatch(setSortTypeOceania()), setCountriesToRender(sortedCountriesList))
            default:
